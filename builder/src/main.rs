...
fn build_project() -> Result<(), io::Error> {
    ...
    const WASM_NAME: &str = "zkmain";
    type WasmParams = (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32);
    type WasmResult = i32;
    ...
    fs::create_dir_all(&guest_src_dir).expect("Failed to create guest_src_dir directory");
    ...
    let release_id = target_dir
        ...
        .join("release");
    let compiled_binary = release_id.join("wasm-interp");
